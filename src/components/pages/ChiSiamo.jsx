  ...
  return (
    <section id="chi-siamo" ref={sectionRef} className="relative py-20 px-6 energized-bg">
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        {/* Header - Energized Editorial style */}
        <div className="text-center mb-12">
          <p
            className={`font-body text-xs uppercase tracking-widest text-editorial-terra mb-4 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            Chi siamo
          </p>
          <h1
            className={`font-elegant text-5xl md:text-6xl text-editorial-text mb-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            style={{ transitionDelay: '0.1s' }}
          >
            La nostra storia
          </h1>
          <div className="section-divider-energized w-24 mx-auto mb-8" />
        </div>
