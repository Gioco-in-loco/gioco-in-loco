    ...
    <section id="associazione" ref={sectionRef} className="relative py-20 px-6 energized-bg min-h-screen">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="bg-white border-2 border-editorial-border rounded-xl p-8 shadow-soft-md energized-card">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap pt-4">
          {assoc.social.instagram && (
            <a
              ...
              className="flex items-center gap-2 px-5 py-3 bg-white border-2 border-editorial-border rounded-lg font-body text-sm text-editorial-text hover:border-editorial-terra hover:text-editorial-terra hover:scale-105 transition-all energized-btn"
            >
              ...
              <span>@{assoc.social.instagram.split('/').pop()}</span>
            </a>
          )}
