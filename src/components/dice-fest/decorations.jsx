...
export function EventMeta({ startDate, endDate, location, mapsUrl, price }) {
  ...
  const locationValue = mapsUrl ? (
    <a
      href={mapsUrl}
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center gap-1.5 text-dicefest-paper underline decoration-dicefest-green decoration-2 underline-offset-4 transition-colors hover:text-dicefest-green"
    >
      {locationLabel}
