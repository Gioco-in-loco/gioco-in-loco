    ...
    <div>
      <div className="relative">
        ...
        <button
          type="button"
          onClick={() => setShow((s) => !s)}
          className="absolute right-3 top-1/2 -translate-y-1/2 text-editorial-text-muted hover:text-editorial-terra transition-colors"
      ...
      {!error && hint && <p className="mt-1.5 font-body text-xs text-editorial-text-muted">{hint}</p>}
    </div>
  )
}
